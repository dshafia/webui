    ...
    return (
        <div className='boxes'>
            <div className='box-container'>
                ...
                <img style={{ objectFit: 'cover', height: '30rem', width: '30rem' }} src='../assets/Paintings/62.webp' />
                </motion.div>
                <motion.div
                    className="box2"
                    style={{ y: y2, x: -50 }}
                ><img style={{ objectFit: 'cover', height: '30rem', width: '30rem' }} src='../assets/Paintings/61.webp' /></motion.div>
            ...
            <div className='box-container-two'>
                ...
                <img style={{ objectFit: 'cover', height: '30rem', width: '30rem' }} src='../assets/Paintings/43.webp' />
                </motion.div>
                <motion.div
                    className="box2"
                    style={{ y: y4, x: -50 }}
                ><img style={{ objectFit: 'cover', height: '30rem', width: '30rem' }} src='../assets/Paintings/41.webp' /></motion.div>
